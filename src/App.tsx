...
export default function App() {
  ...
  return (
    <div className="h-screen w-full bg-[#0F1115] text-white flex flex-col font-sans overflow-hidden">
      {/* MAIN CONTENT AREA */}
      ...
      {/* BOTTOM NAVIGATION */}
      <nav className="fixed bottom-0 left-0 w-full bg-[#0F1115]/80 backdrop-blur-xl border-t border-[#171A21] pb-6 pt-3 px-6 flex justify-around items-center z-40">
        <button 
